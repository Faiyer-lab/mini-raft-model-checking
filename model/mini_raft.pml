...
inline start_election(id)
{
    ...
    if
    :: id != 0 && currentTerm[0] <= currentTerm[id] && votedFor[0] == NONE ->
    ...
    if
    :: id != 1 && currentTerm[1] <= currentTerm[id] && votedFor[1] == NONE ->
    ...
    if
    :: id != 2 && currentTerm[2] <= currentTerm[id] && votedFor[2] == NONE ->
